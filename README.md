...
## Description
This is a dashboard application built using React and styled with Tailwind CSS. It provides a user-friendly interface for visualizing data and managing various aspects of your application.

## Features
- **Responsive Design:** Ensures a seamless experience across various devices and screen sizes.
- **Customizable Components:** Tailwind CSS allows for easy customization and theming.
- **Data Visualization:** Intuitive charts and graphs for visualizing data insights.
...
- Advanced [React] such as folder and file structure, hooks, and refs
- [React] State Management of the entire application using React Context API
- Syncfusion - World's Best UI Component Suite for Building Powerful Web, Desktop, and Mobile Apps

## Installation
1. Clone the repository:
   ```bash
   https://github.com/GobGeeklords/dashBoard-Week-3.git
